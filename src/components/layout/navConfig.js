import {
  ...
  FolderKanban, FileCheck2, Users, BarChart3, Layers, ScrollText, Rocket,
} from 'lucide-react'
  ...
  if (role === 'student') {
    return {
      main: [
        ...
        { to: '/practice', label: 'Amaliy tasklar', icon: Rocket },
  ...
  if (role === 'teacher') {
    return {
      main: [
        ...
        { to: '/teach/practice', label: 'Amaliy tasklar', icon: Rocket },
